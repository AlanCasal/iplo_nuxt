...
<style scoped>
	...
	a:hover {
		color      : var(--iplo-red);
		text-shadow: 2px 2px 4px var(--iplo-darkred), -2px -2px 4px var(--iplo-darkred), 1px 1px 1px var(--iplo-darkred), 6px 6px 9px var(--iplo-darkred), -6px -6px 9px rgb(80, 0, 0);
